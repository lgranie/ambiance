...
public class DefaultMusicBrainzServiceTest extends PlexusTestCase {
	...
	/**
	 * A default {@link DefaultMusicBrainzService}
	 */
	DefaultMusicBrainzService s;
	
	public void setUp() {
	    try {        
			super.setUp();
			s = (DefaultMusicBrainzService)  lookup("org.ambiance.musicbrainz.DefaultMusicBrainzService", "default");
		} catch (Exception e) {
