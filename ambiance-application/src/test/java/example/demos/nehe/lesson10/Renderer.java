package example.demos.nehe.lesson10;
...
import example.demos.common.ResourceRetriever;
import example.demos.common.TextureReader;
...
class Renderer implements GLEventListener {
    ...
    private void setupWorld() throws IOException {
        ...
        try {
            in = new BufferedReader(new InputStreamReader(ResourceRetriever.getResourceAsStream("D:/workspaces/ambiance/ambiance-application/src/test/resources/example/lesson10/data/models/world.txt")));
            String line = null;
    ...
    private void loadGLTextures(GL gl, GLU glu) throws IOException {
        TextureReader.Texture texture = TextureReader.readTexture("D:/workspaces/ambiance/ambiance-application/src/test/resources/example/lesson10/data/images/mud.png");
