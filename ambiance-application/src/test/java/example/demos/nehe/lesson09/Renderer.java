package example.demos.nehe.lesson09;
...
class Renderer implements GLEventListener {
    ...
    private void LoadGLTextures(GL gl) {                                    // Load Bitmaps And Convert To Textures
        ...
        try {
            texture = TextureReader.readTexture("D:/workspaces/ambiance/ambiance-application/src/test/resources/example/lesson09/demos/data/images/star.bmp");
        } catch (IOException e) {
            e.printStackTrace();
